...
const MODEL_PROFILES = {
  'gsd-planner':              { quality: 'opus', balanced: 'opus',   budget: 'sonnet', eco: 'sonnet' },
  'gsd-roadmapper':           { quality: 'opus', balanced: 'sonnet', budget: 'sonnet', eco: 'haiku' },
  'gsd-executor':             { quality: 'opus', balanced: 'sonnet', budget: 'sonnet', eco: 'sonnet' },
  'gsd-phase-researcher':     { quality: 'opus', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'gsd-project-researcher':   { quality: 'opus', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'gsd-research-synthesizer': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'gsd-debugger':             { quality: 'opus', balanced: 'sonnet', budget: 'sonnet', eco: 'sonnet' },
  'gsd-codebase-mapper':      { quality: 'sonnet', balanced: 'haiku', budget: 'haiku',  eco: 'haiku' },
  'gsd-verifier':             { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'gsd-plan-checker':         { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'gsd-integration-checker':  { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  // Ultra agents
  'ultra-pattern-analyst':    { quality: 'opus',   balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'ultra-domain-expert':      { quality: 'opus',   balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'ultra-risk-analyst':       { quality: 'opus',   balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'ultra-ux-investigator':    { quality: 'sonnet', balanced: 'haiku',  budget: 'haiku',  eco: 'haiku' },
  'ultra-builder':            { quality: 'opus',   balanced: 'opus',   budget: 'sonnet', eco: 'sonnet' },
  'ultra-critic':             { quality: 'opus',   balanced: 'opus',   budget: 'sonnet', eco: 'sonnet' },
  'ultra-defender':           { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
  'ultra-attacker':           { quality: 'opus',   balanced: 'sonnet', budget: 'sonnet', eco: 'haiku' },
  'ultra-auditor':            { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku',  eco: 'haiku' },
};
